...
const Collection = ({ className, children, theme, hSpace = 0, vSpace = 0, justify = 'start', verticalJustify }) => {
    ...
    return (react_1.default.createElement("div", { className: className },
        react_1.default.createElement(InnerCollection, { hSpace: actualHSpace, vSpace: actualVSpace, justify: justify }, react_1.default.Children.map(children, child => (react_1.default.createElement(InnerItem, { hSpace: actualHSpace, vSpace: actualVSpace, justify: justify },
