...
const CardContainer = styled_1.default.div({}, ({ theme, horizontal }) => ({
    display: 'flex',
    padding: 0,
...
const CardBase = react_1.forwardRef(({ as = 'div', children, className, horizontal, theme, isRaised = false, isInteractive = false }, ref) => {
    ...
    return (core_1.jsx(CardContainer, { as: as, css: cardCss, className: className, ref: ref, horizontal: horizontal }, children));
});
