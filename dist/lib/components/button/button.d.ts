...
export declare const getButtonStyles: (theme: ThemeInterface, variant?: string) => {
    padding: string;
    fontSize: string;
    fontWeight: number;
    borderRadius: string;
