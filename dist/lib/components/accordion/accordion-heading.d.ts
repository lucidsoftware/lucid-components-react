...
declare const AccordionHeading: import("@emotion/styled-base").StyledComponent<import("react").PropsWithChildren<import("react-accessible-accordion/dist/types/helpers/types").DivAttributes>, Props, {
    colors: {
        text: string;
        background: string;
        heading: string;
