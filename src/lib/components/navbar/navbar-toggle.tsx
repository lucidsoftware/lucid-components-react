...
const NavbarToggle: FC<ThemeProps & HTMLProps<HTMLButtonElement>> = forwardRef(({ theme, children, ...rest }, ref) => {
	...
	return (
		<StyledToggle ref={ref} {...rest} onClick={toggleExpanded}>{children}</StyledToggle>
	);
});
