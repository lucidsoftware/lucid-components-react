...
const Icon = ({ className, type, color, hoverColor, sizing = 'auto', flip }: Props) => {
    ...
    switch (type) {
        case IconType.ArrowRight:
            icon = <svg width="100%" height="100%" viewBox="0 0 12 10" version="1.1">
                <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                    <path d="M11.707031,5.707031 L7.707031,9.707031 C7.511719,9.902344 7.257812,10.0000002 7,10.0000002 C6.742188,10.0000002 6.488281,9.902344 6.292969,9.707031 C5.902344,9.316406 5.902344,8.683594 6.292969,8.292969 L8.585938,6.00000025 L1,6.00000025 C0.449219,6.00000025 0,5.554688 0,5.00000025 C0,4.445312 0.449219,4.00000025 1,4.00000025 L8.585938,4.00000025 L6.292969,1.707031 C5.902344,1.316406 5.902344,0.683594 6.292969,0.292969 C6.683594,-0.097656 7.316406,-0.097656 7.707031,0.292969 L11.707031,4.292969 C12.097656,4.683594 12.097656,5.316406 11.707031,5.707031 Z" fill={color} fillRule="nonzero"></path>
                </g>
            </svg>;
            break;
        case IconType.CarotRight:
            icon = <svg width="100%" height="100%" viewBox="0 0 12 22" version="1.1">
                <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                    <g transform="translate(-1.000000, -1.000000)" fill={color} fillRule="nonzero">
        ...
        case IconType.Play:
            icon = <svg width="100%" height="100%" viewBox="0 0 9 10" version="1.1">
                <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                    <path d="M8.304688,5.402344 L0.695312,9.792969 C0.3125,10.015625 0,9.835938 0,9.390625 L0,0.605469 C0,0.164062 0.3125,-0.015625 0.695312,0.203125 L8.304688,4.597656 C8.6875,4.820312 8.6875,5.179688 8.304688,5.402344 Z" fill={color} fillRule="nonzero"></path>
                </g>
            </svg>;
            break;
        default:
